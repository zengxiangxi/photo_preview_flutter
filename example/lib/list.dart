...
class _ShowListPageState extends State<ShowListPage> {
  ...
  List<Widget> getListView() {
    return [
      ...
      getListViewItem("通用样式（类似微信，自定义转化数据源）",()=> CommonQueryListStylePage.navigatorPush(context)),
      getListViewItem("通用样式（类似微信，单图数据源）",()=> CommonSingleStylePage.navigatorPush(context)),
